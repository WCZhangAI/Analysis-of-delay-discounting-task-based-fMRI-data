...
for i = 1 : nsub
    ...
    %%
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).name = 'SIR';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).onset = Ans_TP_all(tp_info.SIR_trial);
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).duration = RT_all(tp_info.SIR_trial);
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).tmod = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).pmod = struct('name', {}, 'param', {}, 'poly', {});
    %%
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).name = 'LDR';
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).onset = Ans_TP_all(tp_info.LDR_trial);
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).duration = RT_all(tp_info.LDR_trial);
